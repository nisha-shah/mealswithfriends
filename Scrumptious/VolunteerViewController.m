...
@interface VolunteerViewController() <FBLoginViewDelegate>
...
- (IBAction)buttonBrowseOpportunitiesClicked:(id)sender {
    ...
    self.browseViewController=[[BrowseOpportunityTableViewController alloc]initWithNibName:@"BrowseOpportunityTableViewController" bundle:nil];
